...
# Girdi verisini de cihazda oluştur
...
def detect(save_img=False):
    ...
    webcam = source.isnumeric() or source.endswith('.txt') or source.lower().startswith(
        ('rtsp://admin:Istech2021@192.168.1.190'))
    ...
    deepsort = DeepSort(cfg_deep.DEEPSORT.REID_CKPT,
                    ...
                    max_iou_distance=0.7,  # IOU eşiğini artır
                    max_age=70,            # Takip edilen nesneler için bekleme süresi
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--source', type=str, default='rtsp://admin:Istech2021@192.168.1.190:554', help='source')
